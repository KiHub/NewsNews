...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "11", titleText: "Hey, this is news app 👋")
        let page2 = OnboardingViewController(heroImageName: "22", titleText: "Nothing extra, just news 🍩")
